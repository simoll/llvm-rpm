...
make DEST=%{buildroot}/opt/nec/ve/LLVM/%{name}
make DEST=%{buildroot}/opt/nec/ve/LLVM/%{name} rvclang

%install
make DEST=%{buildroot}/opt/nec/ve/LLVM/%{name} installall

%files
%defattr(-,root,root,-)
%dir /opt/nec/ve/LLVM/%{name}
%dir /opt/nec/ve/LLVM/%{name}/bin
%dir /opt/nec/ve/LLVM/%{name}/include
%dir /opt/nec/ve/LLVM/%{name}/lib
%dir /opt/nec/ve/LLVM/%{name}/libexec
%dir /opt/nec/ve/LLVM/%{name}/share
/opt/nec/ve/LLVM/%{name}/bin/*
/opt/nec/ve/LLVM/%{name}/include/*
/opt/nec/ve/LLVM/%{name}/lib/*
/opt/nec/ve/LLVM/%{name}/libexec/*
/opt/nec/ve/LLVM/%{name}/share/*
